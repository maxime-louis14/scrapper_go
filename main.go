...
func main() {
	...
	//  HTML enregistre une fonction. La fonction sera exécutée sur chaque HTML élément correspondant au paramètre
	c.OnHTML(".mntl-card-list-items", func(h *colly.HTMLElement) {
		products := products{
			URL:  h.ChildAttr(".mntl-card-list-items", "href"),
